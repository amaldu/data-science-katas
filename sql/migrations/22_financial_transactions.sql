...
(28, 4, 330.75, NOW() - interval '23 days'),
(29, 5, 340.00, NOW() - interval '22 days'),
(30, 6, 350.25, NOW() - interval '21 days'),
(31, 1, 360.50, NOW() - interval '20 days'),
(32, 2, 370.75, NOW() - interval '19 days'),
(33, 3, 380.00, NOW() - interval '18 days'),
(34, 4, 390.25, NOW() - interval '17 days'),
(35, 5, 400.50, NOW() - interval '16 days'),
(36, 6, 410.75, NOW() - interval '15 days'),
(37, 1, 420.00, NOW() - interval '14 days'),
(38, 2, 430.25, NOW() - interval '13 days'),
(39, 3, 440.50, NOW() - interval '12 days'),
(40, 4, 450.75, NOW() - interval '11 days'),
